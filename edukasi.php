...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                        ...
                        <h4> <i class="ti-pencil-alt"></i> Artikel </h4>
                        <h6>Artikel yang mengedukasi IKM </h6>
                        <ul>
						<?php
   ...
   while($hasil=mysqli_fetch_array($query)){
						...
						?>
                        <li><a href="konten.php?menu=lihatartikel.php&id=<?=$hasil['id'];?>"><?=$hasil['judul'];?></a></li>
   <?php } ?>
                                           </ul>
										    <a href="konten.php?menu=konsultasi.php" class="btn btn-info text-white">Lihat Semua</a>
                    </div>
                    
                    </div>
                        <div class="col-lg-6">
                    <div class="area-heading">
                        <h4><i class="ti-archive"></i> Diskusi dan Konsultasi </h4>
                        <h6>Diskusi seputar IKM bersama para pakar IKM </h6>
                        Diskusi Terkini
                         <!--================ Start Faq Area =================-->
          <?php
		   $query=mysqli_query($con,"select * from konsultasi where jawaban<>'' order by id DESC");
   //echo "sfsdfsfsfsdid".$_GET[id];
   $i=0;
   while($hasil=mysqli_fetch_array($query)){
	   $i++;
		  ?>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0">
                                    <a class="text-info" data-toggle="collapse" data-target="#collapseOne<?=$i;?>" aria-expanded="true" aria-controls="collapseOne<?=$i;?>" >
                                       <i class="ti-comments"> </i> <?=$hasil['tanggal'];?> - <?=$hasil['tanya'];?>
                                    </a>

                                </h5>
                            </div>

                            <div id="collapseOne<?=$i;?>" class="collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                   <?=$hasil['jawaban'];?><br>
                                   <p class="text-success">Dijawab oleh <?=$hasil['penjawab'];?> </p>
                                </div>
                            </div>
                        </div>
   ...
   <?php } ?>
                        ...
                        <a href="konten.php?menu=konsultasi.php" class="btn btn-success text-white">Konsultasi</a> <a href="konten.php?menu=konsultasi.php" class="btn btn-info text-white">Arsip</a>
                    </div>
