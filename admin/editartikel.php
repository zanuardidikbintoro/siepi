...
<link rel="stylesheet" href="./minified/themes/default.min.css" id="theme-style" />
  ...
  <form name="frmkirim" method="post" action="index.php?menu=editartikel.php&aksi=kirim" enctype="multipart/form-data">
<table width="100%" border="0" class="">
  ...
  <tr>
    ...
    <br />
    <a href="index.php?menu=ubahgambar.php&id=<?=$_GET['id'];?>" class="btn btn-info">Ubah Gambar</a>
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
if($_GET["aksi"]=="kirim"){
 $con=mysqli_connect("localhost", "ikmpurwo_root","sangatrahasi4","ikmpurwo_epi");
 $query=mysqli_query($con,"update artikel set judul='$_POST[judul]',isi='$_POST[isi]' where id=$_POST[id]");
 if($query){
