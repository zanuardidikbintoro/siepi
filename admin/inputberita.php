...
<link rel="stylesheet" href="./minified/themes/default.min.css" id="theme-style" />
  ...
  <form name="frmkirim" method="post" action="index.php?menu=inputberita.php&aksi=kirim" enctype="multipart/form-data">
...
$ekstensi_diperbolehkan	= array('png','jpg','jpeg');
 ...
 $query=mysqli_query($con,"insert into berita (judul, isi, gambar) values ('$_POST[judul]','$_POST[isi]','$nama')");
 if($query){
	 echo "Artikel berhasil diinput....silahkan menunggu";
						echo("<meta http-equiv=\"refresh\" content=\"1;url=index.php?menu=inputberita.php\">");
