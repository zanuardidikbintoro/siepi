...
<link rel="stylesheet" href="./minified/themes/default.min.css" id="theme-style" />
  ...
  <form name="frmkirim" method="post" action="index.php?menu=inputgaleri.php&aksi=kirim" enctype="multipart/form-data">
...
$ekstensi_diperbolehkan	= array('png','jpg','jpeg');
			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ukuran < 1044070){			
					move_uploaded_file($file_tmp, '../uploaded/galeri/'.$nama);
 $query=mysqli_query($con,"insert into galeri (judul, isi, gambar) values ('$_POST[judul]','$_POST[isi]','$nama')");
 if($query){
	 echo "Artikel berhasil diinput....silahkan menunggu";
						echo("<meta http-equiv=\"refresh\" content=\"1;url=index.php?menu=inputgaleri.php\">");
