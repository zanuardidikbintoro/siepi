...
?>
 ...
 ?>
 <form name="frmkirim" method="post" action="index.php?menu=ubahgambar.php&aksi=kirim" enctype="multipart/form-data">
 Gambar semula<br>
...
$ekstensi_diperbolehkan	= array('png','jpg');
 ...
 $query=mysqli_query($con,"update artikel set gambar='$nama' where id=$_POST[id]");
 if($query){
	 echo "Artikel berhasil diinput....silahkan menunggu";
						echo("<meta http-equiv=\"refresh\" content=\"1;url=index.php?menu=editartikel.php&id=$_POST[id]\">");
