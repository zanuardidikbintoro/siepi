...
<head>
    ...
    <title>Tentang Kami- Si-EPI</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <section class="hero-banner d-flex align-items-center">
        <div class="container text-center">
            <h2>Tentang Si-EPI </h2>
            <nav aria-label="breadcrumb" class="banner-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Si-EPI</li>
                </ol>
            </nav>
        </div>
    </section>
...
<h3 class="title_color">Tentang Si-EPI</h3>                   </div>
                    
                     <strong>Si-EPI </strong>merupakan sebuah sistem informasi tentang edukasi dan promosi IKM. Sistem ini merupakan sarana berkumpulnya seluruh IKM di Kabupaten Purworejo dan tempat berdiskusi serta promosi produk-produk IKM Purworejo.
                </div>
