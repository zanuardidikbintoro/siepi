...
<head>
<?php
if($_GET["menu"]=="konsultasi.php"){
	$judul="Konsultasi";
	$ket="Tanya jawab bersama narasumber";
}
if($_GET["menu"]=="lihatartikel.php"){
	$judul="Artikel Edukasi";
	$ket="Artikel Selengkapnya";
}
if($_GET["menu"]=="detailikm.php"){
...
$hasil=mysqli_fetch_array($query);
	...
	$judul=$hasil['description']." by ".$hasil['pengusaha'];
	$ket="Detail IKM";
	 $actual_link = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];

}
if($_GET["menu"]=="produkdetail.php"){
	$judul="Produk IKM";
	$ket="Info Detail";
}
?>
