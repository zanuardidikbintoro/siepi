...
<?php  $con=mysqli_connect("localhost", "ikmpurwo_root","sangatrahasi4","ikmpurwo_epi"); ?>
   <!--================Header Menu Area =================-->
    ...
    <!--================Gallery  Area =================-->
    <section class="area-padding-bottom bg-secondary">
        <div class="container">
            ...
            <h3 class="title_color text-white">Event IKM Purworejo</h3>
            <p class="text-white">Informasi Promosi IKM dalam gambar</p>
 ...
 while($hasil=mysqli_fetch_array($query)){
	 ?>
              <div class="col-md-4">
                <a href="uploaded/galeri/<?=$hasil['gambar'];?>" class="img-gal"><div class="single-gallery-image" style="background: url('uploaded/galeri/<?=$hasil['gambar'];?>');"></div>
					<div class="text-white"><?=$hasil['judul'];?></div>
					<font class="text-warning"><?php echo strip_tags($hasil['isi']);?></font>
                </a>
              </div>
             <?php } ?>
            </div>
    ...
    <!--================gallery Area End =================-->
     ...
     <!--================Video  Area =================-->
    <section class="area-padding-bottom bg-dark">
        <div class="container">
        <div class="section-top-border">
            <h3 class="title_color text-white">Galeri Video</h3>
            <p class="text-white">Promosi IKM dalam video</p>
  <div class="row">
	  <?php
 ...
 while($hasil=mysqli_fetch_array($query)){
    ...
    <div class="col-md-6 col-lg-4">
      <iframe width="100%" height="315" src="https://www.youtube.com/embed/<?=$hasil['link'];?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		<p class="text-white"><?=$hasil['judul'];?></p>
    </div>
	  <?php } ?>
       </div>
  </div>
