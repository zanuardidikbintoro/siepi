...
<head>
    ...
    <title>Kontak Kami - Si-EPI</title>
    <!-- Bootstrap CSS -->
...
<h3 class="title_color">Kontak Kami</h3>                   </div>
                    
                     Kantor: Dinas Perindustrian dan Tenaga Kerja Kabupaten Purworejo<br>
					Telepon (0275) 325451, website: dinperinaker.purworejokab.go.id
                </div>
