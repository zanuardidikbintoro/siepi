 ...
 while($hasil=mysqli_fetch_array($query)){
                      ...
                      <article class="blog_item">
                        <div class="blog_item_img">
                         <a href="beritadetail.php?id=<?=$hasil['id'];?>"> <img class="card-img rounded-0" src="uploaded/<?=$hasil['gambar'];?>" alt=""></a>
                         
                        </div>
                        
                        <div class="blog_details">
                            <a class="d-inline-block" href="single-blog.html">
                                <h2><a href="beritadetail.php?id=<?=$hasil['id'];?>"><?=$hasil['judul'];?></a></h2>
                            </a>
                            <p><?php
	 $potong = limit_words($hasil['isi'], 50);
                  ...
                  <div class="blog_right_sidebar">
                      ...
                      <aside class="single_sidebar_widget popular_post_widget">
                         <h3 class="widget_title">Berita Terbaru</h3>
						  <?php
							 $query=mysqli_query($con,"select * from berita order by id DESC limit 0,5");
