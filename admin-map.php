...
<script>
    ...
    function initMap() {
        ...
        var france = {lat: -7.7131357, lng: 110.0102464};
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyBmD-nZ5UA3dqCfR-it4jjN1qVsafwqS78&callback=initMap">
</script>